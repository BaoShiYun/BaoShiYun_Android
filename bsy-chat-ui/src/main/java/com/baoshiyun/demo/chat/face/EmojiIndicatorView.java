...
public class EmojiIndicatorView extends LinearLayout {
    ...
    public EmojiIndicatorView(Context context, AttributeSet attrs) {
        ...
        bmpSelect = BitmapFactory.decodeResource(getResources(), R.drawable.bsyl_indicator_point_select);
        bmpNomal = BitmapFactory.decodeResource(getResources(), R.drawable.bsyl_indicator_point_nomal);
    }
